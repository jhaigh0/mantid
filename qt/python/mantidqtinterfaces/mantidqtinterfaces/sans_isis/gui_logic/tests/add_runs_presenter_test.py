...
class InitializationTest(AddRunsPagePresenterTestCase):
    ...
    @mock.patch("mantidqtinterfaces.sans_isis.presenter.add_runs_presenter.SummationSettingsModel", autospec=True)
    @mock.patch("mantidqtinterfaces.sans_isis.presenter.add_runs_presenter.SummationSettingsPresenter", autospec=True)
