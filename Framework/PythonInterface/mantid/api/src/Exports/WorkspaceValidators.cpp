...
void export_WorkspaceValidators() {
  ...
  EXPORT_WKSP_VALIDATOR_ARG(WorkspaceUnitValidator, std::string, "unit",
  ...
  class_<MDFrameValidator, bases<TypedValidator<IMDWorkspace_sptr>>, boost::noncopyable>(
      "MDFrameValidator", init<std::string>(arg("frameName"), "Checks the MD workspace has the given frame along all "
  ...
  class_<PolSANSWorkspaceValidator, bases<TypedValidator<WorkspaceGroup_sptr>>,
      ...
      .def("__init__",
           make_constructor(&polSANSValidatorConstructor, default_call_policies(),
                            (arg("expectHistogramData"), arg("allowMultiPeriodData"), arg("allowedNumberOfPeriods"))),
